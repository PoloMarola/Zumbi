export const perguntas = [
    {
        enunciado: "Assim que saiu da escola você se depara com um zumbi, um cientista aparece e mata ele, após isso ele te diz, a nossa cidade está infectada com um vírus mortal ",
        alternativas: [
            {
                texto: "Isso é assustador!",
                afirmacao: [
                    "Você fica preocupado com seu coelho albino de estimação.",
                    "Você fica triste pois suas compras da Shein ia chegar amanhã."
                ],
                proxima: 1,
            },
            {
                ...
                afirmacao: [
                    "Não vou precisar pagar contas.",
                    "Vou poger ficar sem pagar imposto."
                ],
                proxima: 2,
            },
        ]
    ...
    {
        enunciado: "O cientista te dá uma missão, de ir para a casa do prefeito buscar o antidoto",
        alternativas: [
            {
                texto: "Pode crê pia, é os guri não tem jeio",
                afirmacao: [
                    "Ele foi de Chevette com um paraguaio vendedor de Marloro.",
                    "Ele foi andando pela rua principal.",
                    "Ele foi de skate sem proteção."
                ],
                proxima: 3,
            },
            {
                texto: "VÔ NADA!.",
                afirmacao: [
                    "Ele enlouqueceu e correu pelado pela rua.",
                    "ele agrediu o cientista, roubou o Chevette dele.",
                    "e decidiu invadir uma casa para assistir bora bill, amostradinhom, receba."
                ],
                proxima: 4,
            },
        ]
    ...
    {
        enunciado: "Vou até a casa do prefeito, era extremamente grande, pelo corredor escuto barulhos de tiro, o que você faz",
        alternativas: [
            {
                texto: "Vou até lá averiguar o que é, o cuzinheiro estava matando o prefeito zumbificado.",
                afirmacao: [
                    "Mato os dois porque sou porra louca.",
                    "COnverso com ele, mas ele está infectado, saio correndo dali o mais rápido possível.",
                    "saio correndo."
                ],
                proxima: 3,
            },
            {
                texto: "Escuto o brarulho e passo reto, o seguro morreu de velho.",
                afirmacao: [
                    "Ando tranquilamente pelo local.",
                    "Meio amendrotado saio andando.",
                    "Dou dois pulos e saio dando cambalhota."
                ],
                proxima: 4,
            },
        ]
